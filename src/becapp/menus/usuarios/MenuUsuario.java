...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		/**
		 * accion para el botÃ³n de cerrar sesion
		 */
		...
		/**
		 * accion para para el botÃ³n calcular umbral
		 */
	...
	/**
	 * 
	 * Mï¿½todo que crea y da formato a la tabla que se muestra en el menï¿½ de
	 * navegaciï¿½n de usuario. Tambiï¿½n aï¿½ade un botï¿½n con funcionalidad de ver mï¿½s
	 * informaciï¿½n de la beca seleccionada,
	 */
	...
	/**
	 *
	 * MÃ©tddo que crea una matriz con los datos rescatados de la tabla becas (nombre
	 * y descripciÃ³n)
	 * 
	 * @return Una matriz de objectos para la generaciÃ³n posterior de una tabla
	 */
