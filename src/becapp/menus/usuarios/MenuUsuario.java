...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		/**
		 * accion para el botón de cerrar sesion
		 */
		...
		/**
		 * accion para para el botón calcular umbral
		 */
	...
	/**
	 *
	 * Métddo que crea una matriz con los datos rescatados de la tabla becas (nombre
	 * y descripción)
	 * 
	 * @return Una matriz de objectos para la generación posterior de una tabla
	 */
