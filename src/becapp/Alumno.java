...
public class Alumno extends Usuario {
	...
	public Alumno(String dni, String nombre, String apellido, String nacionalidad, String email, int telf,
			String fecha_nac, Integer numero_familiares, double ingreso_anual, List<Beca> becasFavoritas,
