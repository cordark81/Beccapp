...
public class Alumno extends Usuario {
	 ...
	 * @author Eduardo y Arturo
	 * 
	 *         El siguiente m�todo nos permite calcular el umbral econ�mico en el
	 *         que se encuentra el usuario que introduce los datos. Posteriormente
	 *         esta variable umbral se utiliza para calcular la cuant�a monetaria de
	 *         la beca.
	 * 
	 * @param numFamilia
	 * @param dinero
	 ...
	 * 
	 * 
	 * El siguiente m�todo nos sirve para calcular la cuant�a de la beca.
	 * 
	 * @param umbral
	 * @param universitario
